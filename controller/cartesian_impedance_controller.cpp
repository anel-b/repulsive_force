...
CallbackReturn CartesianImpedanceController::on_configure(const rclcpp_lifecycle::State& /*previous_state*/) {
  ...
  try {
    ...
    F_repulsion_subscriber = get_node()->create_subscription<geometry_msgs::msg::WrenchStamped>(
      "F_repulsion_topic", qos_profile,
      std::bind(&CartesianImpedanceController::F_repulsion_callback, this, std::placeholders::_1));
    //END Repulsion force
  }
...
//START Repulsion force
void CartesianImpedanceController::F_repulsion_callback(const std::shared_ptr<geometry_msgs::msg::WrenchStamped> msg) {
